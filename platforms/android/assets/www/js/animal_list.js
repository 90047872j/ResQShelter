...
function doCreateTable() {
    db.transaction(createTableAnimalTx, errorCB, successCB);
}

function createTableAnimalTx(tx) {
...
function doListItems(){
     db.transaction(listItemsAnimalTx, errorCB, successCB);
}
function listItemsAnimalTx(tx) {
...
function doAddDummyItems(){
    db.transaction(addItemsAnimalTx, errorCB, successCB);
    doListItems();
}
function addItemsAnimalTx(tx) {
...
function openCreate(){
    window.location = "create_animal.html";
}
